...
<div class="head">
	<div class="head_left">
		<div class="logo">
        	<a href="/index.php?lang=en"><img src="/template/default/images/logo.jpg" border="0" /></a>            
        </div>
	</div>    
...
<div class="contain">
	<div class="contain_left">
		<!--侧栏导航-->
			...
			<div class="box_in">
				<div class="news_list">
					<ul>
												<li><a class="" href="/alone/alone.php?id=69"  title="Company introduction">Company introduction</a></li>
												<li><a class="" href="/alone/alone.php?id=70"  title="Organization structure">Organization structure</a></li>
												<li><a class="" href="/alone/alone.php?id=71"  title="Enterprise culture">Enterprise culture</a></li>
												<li><a class="focus" href="/alone/alone.php?id=75"  title="Contact us">Contact us</a></li>
											</ul>  
				</div>
			</div>
		</div><!--容器结束-->
	...
	<div class="contain_right">
		<div class="box">
			<div class="box_title"><h2 class="position"><span>Location:<a href="/index.php?lang=en">Home</a> > <a href="/alone/alone.php?id=75">Contact us</a></span></h2></div>
			<div class="box_in">
				<!--<p class="title" style=""></p>
				<p class="info"><span>Clicks:<script language="javascript" src="/includes/hits.php?id="></script></span><span>Updated:1970-01-01 08:01:00</span><span><a href="javascript:window.print()">【Print】</a></span><span><a href="javascript:self.close()">【Close】</a></span></p>
...
//修改左侧导航文字
$(function(){
	var title = $(".focus").eq(1).find("a").eq(0).find("span").html();
	$(".left_title h2").html(title);
});
</script>
