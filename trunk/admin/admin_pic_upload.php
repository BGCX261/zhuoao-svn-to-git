...
back_img='<?php echo CMS_SELF;?>upload/'+$pic_val;
...
?>
<li>
<img src="<?php echo $img?>" border="0" width="80" height="80" alt="【图片说明】：<?php echo $v['pic_alt']?>【上传时间】：<?php echo date('Y-m-d H:m:s',$v['pic_time']);?>【格式】：<?php echo $v['pic_ext'];?>" />
...
<div class="pic_cz" style="display:none"><a title="查看" class="xg_link" href="#"></a></div>
